...
function extFromMime(mime: string): string {
  ...
  // Strip any parameters (e.g. "ogg; codecs=opus") before mapping.
...
function isMuted(notify?: Api.TypePeerNotifySettings): boolean {
...
function canSendTo(entity: EntityLike): boolean {
...
function matchesFolderFlags(f: Api.DialogFilter, e: EntityLike): boolean {
